...
alias unstage='git restore --stage'
...
alias stashcode='git stash push -p -m "selected-codes"'
...
# git rebase --onto {new_branch} {old_branch}
alias bisect='git bisect'
alias start='git bisect start'
alias good='git bisect good'
alias bad='git bisect bad'
alias end='git bisect reset'
alias push='git push'
